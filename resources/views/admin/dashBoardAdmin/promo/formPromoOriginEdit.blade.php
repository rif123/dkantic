...
<div class="card">
    ...
    <div class="card-content">
        ...
        <form class="form-config-website" action="{{ route('promoOrigin.doUpdatePromo') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        <label class="control-label">Nama Promo</label>
                        <input type="text" class="form-control nama_kota" name="nama_promo" value="{{ !empty($dataConfig['nama_promo']) ? $dataConfig['nama_promo'] : '' }}" data-error=".nama_promoTxt">
            ...
            <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-12">
                            <input type="text" class="form-control imageBannerName"  value="{{ !empty($dataConfig['image_promo']) ? $dataConfig['image_promo'] : '' }}"  readonly placeholder="Banner Promo">
                        </div>
                    </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataStart" name="date_start_promo" value="{{ !empty($dataConfig['date_start_promo']) ? $dataConfig['date_start_promo'] : '' }}" data-error=".date_start_promoTxt">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataEnd" name="date_end_promo" value="{{ !empty($dataConfig['date_end_promo']) ? $dataConfig['date_end_promo'] : '' }}" data-error=".date_end_promoTxt">
