...
<div class="card">
    <div class="card-header" data-background-color="orange">
        <h4 class="title">Form Promo Slide</h4>
    </div>
    <div class="card-content">

        <form class="form-config-website" action="{{ route('promoSLideLanding.doSaveSlide') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        <label class="control-label">Nama Promo Slide</label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataStart" name="date_start_slide" value="{{ !empty($dataConfig['nama_kota']) ? $dataConfig['nama_kota'] : '' }}" data-error=".date_start_promoTxt">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataEnd" name="date_end_slide" value="{{ !empty($dataConfig['nama_kota']) ? $dataConfig['nama_kota'] : '' }}" data-error=".date_end_promoTxt">
