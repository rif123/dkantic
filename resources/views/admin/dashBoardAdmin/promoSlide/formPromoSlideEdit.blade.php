...
<div class="card">
    <div class="card-header" data-background-color="orange">
        <h4 class="title">Form Edit Promo</h4>
    </div>
    <div class="card-content">

        <form class="form-config-website" action="{{ route('promoSLideLanding.doUpdatePromoSlide') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        <label class="control-label">Nama Promo</label>
                        <input type="text" class="form-control nama_kota" name="nama_slide" value="{{ !empty($dataConfig['nama_slide']) ? $dataConfig['nama_slide'] : '' }}" data-error=".nama_promoTxt">
                        ...
                        <div class="col-md-2 col-sm-12">
                            <label class="input-group-btn">
                                <span class="btn btn-info btn-sm">
                                    Browse<input type="file" class="imageBanner" name="image_slide" style="display: none;"> 
                                </span>
                            </label>
                        </div>
                        <div class="col-md-10 col-sm-12">
                            <input type="text" class="form-control imageBannerName"  name="imageBanner" value="{{ !empty($dataConfig['image_slide']) ? $dataConfig['image_slide'] : '' }}"  readonly placeholder="Banner Promo">
                        </div>
                    </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataStart" name="date_start_slide" value="{{ !empty($dataConfig['date_start_slide']) ? $dataConfig['date_start_slide'] : '' }}" data-error=".date_start_promoTxt">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control dataEnd" name="date_end_slide" value="{{ !empty($dataConfig['date_end_slide']) ? $dataConfig['date_end_slide'] : '' }}" data-error=".date_end_promoTxt">
                        <div class="date_end_promoTxt"></div>
                    </div>
                </div>
            </div>
            <input type="hidden" name="_token" value="{{ csrf_token() }}" >
            <input type="hidden" name="id_slide" value="{{ !empty($dataConfig['id_slide']) ? $dataConfig['id_slide'] : '' }}" >
