...
<form class="form-add-product" action="{{ route('ProductAdmin.formProdukSave') }}" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8 col-sm-12">
            <input type="text" class="form-control img-text"  value="{{ !empty($dataConfig[0]['name_image_produk']) ?$dataConfig[0]['name_image_produk'] : '' }}"  readonly placeholder="Image 1" >
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-4 col-sm-12">
        ...
        <div class="col-md-8 col-sm-12">
            <input type="text" class="form-control img-text"  value="{{ !empty($dataConfig[1]['name_image_produk']) ? $dataConfig[1]['name_image_produk'] : '' }}"  readonly placeholder="Image 2">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-4 col-sm-12">
        ...
        <div class="col-md-8 col-sm-12">
            <input type="text" class="form-control img-text"  value="{{ !empty($dataConfig[2]['name_image_produk']) ? $dataConfig[2]['name_image_produk'] : '' }}"  readonly placeholder="Image 3">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-4 col-sm-12">
        ...
        <div class="col-md-8 col-sm-12">
            <input type="text" class="form-control img-text"  value="{{ !empty($dataConfig[3]['name_image_produk']) ? $dataConfig[3]['name_image_produk'] : '' }}"  readonly placeholder="Image 4">
        </div>
    </div>
