...
<div class="card">
    <div class="card-header" data-background-color="orange">
        <h4 class="title">Form Tambah Slide Items</h4>
    </div>
    <div class="card-content">

        <form class="form-promo-items" action="{{ route('promoSLideLanding.doSaveRoleSlideItems') }}" method="POST" enctype="multipart/form-data">
             <div class="row">
                <div class="col-md-12">
                    <div class="form-group label-floating">
                        <label class="control-label">Promo</label>
                        <select name="id_slide" class="getPromo form-control" data-error=".promoTxt"> 
...
<script>
    ...
    var urlGetPromoList = "{{ route('promoSLideLanding.getPromoListItems') }}";
     $(function () {
        $(".getPromo").select2({
            ajax: {
                url: urlGetPromoList,
