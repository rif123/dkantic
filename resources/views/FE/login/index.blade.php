                ...
                <div class="row">
                    ...
                    <div class="box-border">
                        ...
                        <form action="{{ url(route('user.doReg')) }}" method="post" id="formReg" >
                            ...
                            <p>
                                <label>Hp</label>
                                <input name="hp_customer" type="text" class="hp_customer" data-error=".hp_customerTxt" />
                                <div class="hp_customerTxt"></div>
                            </p>

                            <p>
                                <label>Password</label>
                                <input name="pass_customer" type="password" class="pass_customer" data-error=".pass_customerTxt" />
                        ...
                        <div class="box-border">
                            ...
                            <form action="{{url(route('user.doLogin'))}}" method="post" id="login">
                                <p>
                                    ...
                                    <input type="text" name="nama_customer" autocomplete="off" data-error=".nama_customerTxt">
                                    <div class="nama_customerTxt"></div>
                                </p>
                                <p>
                                    <label>Password</label>
