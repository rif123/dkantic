...
<div class="main-panel">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="orange">
                                <h4 class="title">Preview Promo</h4>
                            </div>
                            <div class="card-content  table-responsive">
    ...
    <script>
    var urlAjaxTable  = "{{ route('promoOrigin.getPromo') }}";
    var urlAjaxGetRoleProd  = "{{ route('promoOrigin.getRolePromo') }}";
    var urlAjaxFormPromo  = "{{ route('promoOrigin.showFormPromo') }}";
    var urlAjaxFormEditPromo  = "{{ route('promoOrigin.showFormPromoEdit') }}";
    var urlAJaxShowPromoItems  = "{{ route('promoOrigin.showFormItems') }}";
    var urlUpdate  = "{{ route('masterKota.update') }}";
    var urlDeletePromo  = "{{ route('promoOrigin.doDeletePromo') }}";
    var pathImage = "{{ asset('/imagePromo') }}";
    ...
    var listTable = $('.listGlobal').DataTable( {
                        ...
                        "columns": [
                            ...
                            { "render": function (data, type, row, meta) {
                                var image = "<img src='"+ pathImage + "/" +  row.image_promo +"' />";
                                return image;
                                }
                            },
                            { "render": function (data, type, row, meta) {
                                var edit = $('<a><button>')
                                            ...
                                            .attr('onclick','setForm(\''+row.id_promo+'\', \''+row.nama_promo+'\',  \''+row.image_promo+'\',  )')
                                            .text('Edit')
                                            .wrap('<div></div>')
                                            .parent()
                                            .html();
                                var del = $('<button>')
                                            ...
                                            .attr('onclick','showConfirm(\''+row.id_promo+'\')')
                                            .text('Delete')
                                            .wrap('<div></div>')
                                            .parent()
                                            .html();
                                var promo = $('<button>')
                                            ...
                                            .attr('onclick','detail(\''+row.id_promo+'\')')
                                            .text('Preview')
                                            .wrap('<div></div>')
                                            .parent()
                                            .html();
